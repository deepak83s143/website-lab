    ...
    stages {
            ...
            steps {
                script {
                    ...
                    if (params.environment == 'prod') {
                        ...
                        sh "scp website2.yaml ubuntu@10.201.18.116:~/website"
        ...
        stage('Send artifacts to K8s') {
            ...
            script {
                ...
                sleep 5
                microk8s kubectl apply  -f website2.yaml''', execTimeout: 120000, flatten: false, makeEmptyDirs: false, noDefaultExcludes: false, patternSeparator: '[, ]+', remoteDirectory: '/home/ubuntu/website', remoteDirectorySDF: false, removePrefix: '/home/ubuntu/website', sourceFiles: '/home/ubuntu/website/website2.yaml')], usePromotionTimestamp: false, useWorkspaceInPromotion: false, verbose: false)])
                    } 
                    if (params.environment == 'prod') {
